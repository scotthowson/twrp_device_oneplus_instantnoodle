...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := instantnoodle
...
TARGET_KERNEL_CONFIG := instantnoodle_defconfig
TARGET_KERNEL_SOURCE := kernel/oneplus/instantnoodle
...
BOARD_oneplus_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product my_product my_engineering
BOARD_oneplus_DYNAMIC_PARTITIONS_SIZE := 9122611200 # TODO: Fix hardcoded value

# Platform
TARGET_BOARD_PLATFORM := instantnoodle
